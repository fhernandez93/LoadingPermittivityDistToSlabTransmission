...
- **Structure**: 3D LSU dielectric (`n = 3.4`), elliptical rods (`AR = 2.5`) perforated
  with elliptical holes (`AR = 2.5`); unperforated `ff = 0.2172`, hole fraction ≈ 0.22.
...
- **Thickness sweep**: `L = 2, 3, 4, 5, 6, 7, 8, 10, 11, 12, 14, 15` (lattice units;
  `L = 9` lives in the sibling `../L_9/` folder).
...
```
z_5.0/
  transmission_n_3.4_ff_0.2172_z_5.0_Transmission_Components_average_L_{L}.txt
  transmission_n_3.4_ff_0.2172_z_5.0_Transmission_Components_average_L_{L}.png
```
