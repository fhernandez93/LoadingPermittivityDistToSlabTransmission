...
},rf"F:\2D SHU Chi Statistics\data\10_07_2024 Beam Spreading Broad Bandwidth Periodic Conditions Freq Domain\fluxes_right.h5")
...
AM.create_hdf5_from_dict({
    ...
    "sample":np.linspace(0,4,5),
    "f":sim_result.sim_data.get_intensity("freq_monitorFieldOut").f.values,
},rf"F:\2D SHU Chi Statistics\data\10_07_2024 Beam Spreading Broad Bandwidth Periodic Conditions Freq Domain\fluxes_left.h5")